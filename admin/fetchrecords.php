...
$branches[7]="Production";
	...
	while($count--) {
		...
		$tableid = "table_".$i;
 		$rethtml = $rethtml."<h3>$branches[$i]</h3><div class='table-responsive'><button id='export_".$tableid."' data-export='export' onclick=download('".$tableid."')>Download Info</button><br><br><b>Search: </b><input type='text' class='search' id='t_".$tableid."' placeholder='Type a keyword'></input><table class='table' id=table_".$i."><caption>Placement Record for $branches[$i]_BE</caption><thead><th><b>Student ID</b></th><th><b>Student Name</b></th><th><b>Gender</b></th><th><b>Student Branch</b></th><th><b>Category</b></th><th><b>CGPA</b></th><th class='noExl'><b>Status</b></th><th><b>1st Company</b></th><th><b>Package</b></th><th><b>2nd Company</b></th><th><b>Package</b></th><th><b>3rd Company</b></th><th><b>Package</b></th><th class='noExl'><b>Eligible</b></th><th class='noExl'><b>Blocked?</b></th></thead>";
