...
<head>
    <meta charset="utf-8" />
    <title>TPO PEC: Admin Login</title>
...
<div class="page-header">
    <font color="white"><h2 align="center">Training and Placement Cell Admin, PEC Chandigarh</h2></font>
</div>
...
<font color="white"><h2 class="form-signin-heading">Please sign in</h2></font>
    <div class="form-group">
        <input type="text" class="form-control" id="aname" name="aname" placeholder="Admin Username" autofocus="">
    </div>
    <div class="form-group">
        <input type="password" class="form-control" id="apass" name="apass" placeholder="Admin Password" pattern="^[a-zA-Z0-9_- ]*$">
    </div>
    <div class="form-group">
