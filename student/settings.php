        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
        		...
        		<form class="form-signin" method="POST" action="settings.php" >
					...
					<h5>Passwords must be 5-13 character long and not allowed to contain <br>( , . " ' + = ) / \ < > & $ % ! # * @</h5>
                	...
                	<label for="new-password" class="sr-only" pattern="">New Password</label>
                	<input type="password" id="new-password" name="new-password" class="form-control" placeholder="New Password" pattern="[a-zA-Z0-9_- ]{5,13}" title="5 to 13 characters" required>
                	<label for="new-password-confirm" class="sr-only">New Password Confirm</label>
                	<input type="password" id="new-password-confirm" name="new-password-confirm" class="form-control" placeholder="Confirm New Password" pattern="[a-zA-Z0-9_- ]{5,13}" required=""><br>
